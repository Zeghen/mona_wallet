                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('account'.tr, style: rubikLight.copyWith(color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(0.9), fontSize: Dimensions.FONT_SIZE_LARGE)),
                              Expanded(
                                child: TextField(
                ...
                builder: (controller) {
                  return FloatingActionButton(
                    ...
                    child: controller.isLoading
                        ? SizedBox(height: Dimensions.PADDING_SIZE_LARGE, width:  Dimensions.PADDING_SIZE_LARGE, child: CircularProgressIndicator(color: Theme.of(context).textTheme.bodyLarge.color,),)
