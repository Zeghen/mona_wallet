                          ...
                          child: Column(
                            ...
                            Container(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(AppConstants.onboardList[index].title, style: rubikSemiBold.copyWith(color: Theme.of(context).textTheme.bodyLarge.color, fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE,), textAlign: TextAlign.center,),
