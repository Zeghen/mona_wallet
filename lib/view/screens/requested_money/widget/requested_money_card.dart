      ...
      child: Column(children: [
        Container(
          ...
          child: Column(children: [
           ...
           if(widget.requestType == RequestType.WITHDRAW)
             _methodFieldView(type: 'charge'.tr, value: PriceConverter.balanceWithSymbol(balance: '${widget.withdrawHistory.adminCharge}')),

            if(widget.requestType == RequestType.WITHDRAW)
              _methodFieldView(type: 'total_amount'.tr, value: PriceConverter.balanceWithSymbol(balance: '${widget.withdrawHistory.amount + widget.withdrawHistory.adminCharge}')),
          ],),
        ),
