          ...
          SliverPersistentHeader(
            ...
            delegate: SliverDelegate(
                child: Column(children: [
                  ...
                  Divider(height: Dimensions.DIVIDER_SIZE_SMALL, color: Theme.of(context).cardColor),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              Column(
                                ...
                                children: [
                                  Text(cashOutController.cashOutSuggestList[index].name == null ?'Unknown':cashOutController.cashOutSuggestList[index].name,style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,color: Theme.of(context).textTheme.bodyLarge.color)),
